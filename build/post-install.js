...
function writeConfigFile(fileLoc, config) {
...
function createExampleCampaign(exampleDir) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise(res => {
...
function postInstall() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const help = yield inquirer.prompt([
            {
                type: 'confirm',
        ...
        var extraNote = '';
        const projectConfig = yield inquirer.prompt([
            {
                type: 'confirm',
        ...
        if (projectConfig.create_example_campaigns) {
            yield createExampleCampaign(path.join(projectFolder, 'customer', 'some-campaign', 'variation-1'));
            yield createExampleCampaign(path.join(projectFolder, 'customer', 'some-campaign', 'variation-2'));
            yield createExampleCampaign(path.join(projectFolder, 'customer', 'some-other-campaign', 'variation-1'));
            yield createExampleCampaign(path.join(projectFolder, 'customer', 'some-other-campaign', 'variation-2'));
            yield createExampleCampaign(path.join(projectFolder, 'another-customer', 'some-campaign', 'variation-1'));
            yield createExampleCampaign(path.join(projectFolder, 'another-customer', 'some-campaign', 'variation-2'));
            yield createExampleCampaign(path.join(projectFolder, 'another-customer', 'some-other-campaign', 'variation-1'));
            yield createExampleCampaign(path.join(projectFolder, 'another-customer', 'some-other-campaign', 'variation-2'));
        }
        var scriptKey = 'start';
